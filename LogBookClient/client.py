...
class ElogClient(object):
    ...
    def add_logbook(self, hutch, facilities=False,
        ...
        if logbook not in self.logbooks:
            ...
            return logbook
        #Otherwise, report a previously loaded logbook
    ...
    def post(self, text,  tags=None, attachments=None,
             run=None, verify=False,):
        """
        Create a log entry
